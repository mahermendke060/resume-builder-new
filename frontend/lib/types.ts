...
export interface TailorRunDetail {
  ...
  created_at: string;
  updated_at: string;
  variants: Array<{ id: string; content_json: Record<string, any>; provenance_json: any; docx_key: string | null; pdf_key: string | null; created_at: string; updated_at: string }>;
  scores: ScoreOut[];
}
